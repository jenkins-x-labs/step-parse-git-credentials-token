...
// NewCmdStepGetGitCredentialToken creates a command object for the "step get git credential token" command
func NewCmdStepGetGitCredentialToken() *cobra.Command {
	o := &options{}
...
func Run(args []string) error {
	cmd := NewCmdStepGetGitCredentialToken()
	if args != nil {
		args = args[1:]
		cmd.SetArgs(args)
	}
